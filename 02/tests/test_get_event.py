...
# from globoticket.api import app, get_event
...
def test_get_event(mock_get_dbevent):
    ...
    assert get_event(id=25, db="Fake db") is mock_get_dbevent.return_value  # type: ignore
...
def test_get_event_404(_):
    ...
    with pytest.raises(HTTPException):
        get_event(id=0, db=None)  # type: ignore
